...
public class SessionDeleteServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 2. session객체의 removeAttribute()메서드를 이용해서 session값 삭제
		//		=> 세션 자체가 삭제되지 않고 해당 세션값만 삭제됨
		//		형식) session객체변수.removeAtrribute("key값");
		...
		out.println("<body>"); 
		out.println("<h2>저장된Session 데이터 삭제하기</h2><hr>");
		out.println();
